...
set numframes [molinfo top get numframes]
	...
	set Azn_com [measure center ${AznCoord} weight mass ]
	$BznCoord frame $frame
	set Bzn_com [measure center ${BznCoord} weight mass ]

	puts $outfile "$molname	!	$frame	!	$ad1_com $ad2_com $alink_com $ad3_com $ad4_com $bd1_com $bd2_com $blink_com $bd3_com $bd4_com $Azn_com $Bzn_com 0 0 0 0 0 0"

	puts "ApoCoords $traj: $frame of $numframes"
}
